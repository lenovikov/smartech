		...
		<>
			...
			{!hasInstalment && (
				<form onSubmit={handleSubmit(onSubmit)} className='w-full mx-auto p-6 bg-white rounded-lg shadow-md'>
					...
					{/* Submit Button */}
					<Button
						disabled={hasInstalment || isLoading}
						variant='primary'
						type='submit'
						className='px-4 py-3 w-full mb-2'
					>
						Оформить заказ
					</Button>
				</form>
			...
			{hasInstalment && (
				<div>
					<p className='mb-2'>
						Если хотите оформить рассрочку, сделайте скриншот вашей корзины и отправьте нашему менеджеру по ссылке ниже
					</p>
